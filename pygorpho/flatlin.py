...
def dilate_erode(vol, lineSteps, lineLens, op, blockSize=[256,256,512]):
...
def dilate(vol, lineSteps, lineLens, blockSize=[256,256,512]):
    dilate_erode(vol, lineSteps, lineLens, constants.DILATE, blockSize)
    

def erode(vol, lineSteps, lineLens, blockSize=[256,256,512]):
    dilate_erode(vol, lineSteps, lineLens, constants.ERODE, blockSize)